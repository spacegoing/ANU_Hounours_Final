...
\begin{document}
	...
	\subsection{Background}
		...
		\end{align}
		where $ D\boldsymbol{\theta}\geq \mathbf{0}$. Hence \cite{aleksander1990introduction}the Equation 2 can be optimized using max-margin framework with an additional linear constraint.\cite{fahlman1989cascade}
